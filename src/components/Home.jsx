...
const Home = () => {
  const reactTypedList = ['Full Stack', 'Frontend', 'Node.js', 'React', 'TypeScript', 'MongoDB']
  return (
    <Section
      id="home"
      classes="parallax w-full h-screen bg-[image:var(--image-url-sm)] md:bg-[image:var(--image-url-md)] lg:bg-[image:var(--image-url-lg)]"
      style={{
        '--image-url-lg': `url(${heroLarge})`,
        '--image-url-md': `url(${heroMedium})`,
        '--image-url-sm': `url(${heroSmall})`,
      }}
      name="home"
    >
      <div className="max-w-[1200px] flex flex-col justify-center h-full gap-2">
        ...
        <p className="text-custom_gray-600 py-4 max-w-[700px]">
          I specialize in building and designing exceptional digital experiences. Currently, I'm focused on building

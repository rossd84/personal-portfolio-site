      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="md:border-r-4 md:border-secondary-400 pr-12 py-12">
          <form className="flex flex-col max-w-[600px] w-full gap-2" method="POST" ref={form} onSubmit={sendEmail}>
            ...
            <div>
              <button
                className="rounded-sm text-custom_gray-500 border-2 hover:bg-accent-500 hover:border-accent-500 hover:text-primary-500 duration-200 px-4 py-3 my-2 mx-auto w-full"
                type="submit"
              >
                Send Message
              </button>
        ...
        <div className="pl-12 py-12">
          <div className="border-b-2 border-secondary-400 flex flex-col gap-12 pb-12">
            ...
            <p className="flex items-center justify-center relative">
              <span className="pr-8 absolute left-0">
                <VscLocation size={30} />
              </span>
              Hattiesburg, MS
            </p>
            <a
              className="hover:text-accent-500 flex items-center justify-center relative"
              href="mailto:darbyross.dev@gmail.com"
            >
              <span className="pr-8 absolute left-0">
                <VscMail size={30} />
              </span>
